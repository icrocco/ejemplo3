...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { code: @lecture.code, name: @lecture.name, professor_id: @lecture.professor_id } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { code: @lecture.code, name: @lecture.name, professor_id: @lecture.professor_id } }
